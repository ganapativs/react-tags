  ...
  function ReactTags() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactTags.__proto__ || Object.getPrototypeOf(ReactTags)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          handleBeforeDelete = _this$props.handleBeforeDelete,
          handleDelete = _this$props.handleDelete;

      var allowTagDelete = handleBeforeDelete(i);
      ...
      var _this$props2 = _this.props,
          handleBeforeAddition = _this$props2.handleBeforeAddition,
          autocomplete = _this$props2.autocomplete,
          suggestions = _this$props2.suggestions,
          handleAddition = _this$props2.handleAddition;
      var input = _this.refs.input;


      if (autocomplete) {
        var possibleMatches = _this.filteredSuggestions(tag, suggestions);

        if (autocomplete === 1 && possibleMatches.length === 1 || autocomplete === true && possibleMatches.length) {
          tag = possibleMatches[0];
        }
      }
      var allowTagAddition = handleBeforeAddition(tag);
      if (!allowTagAddition) {
        return;
      }
...
ReactTags.propTypes = {
  ...
  handleBeforeDelete: _propTypes2.default.func,
  handleAddition: _propTypes2.default.func.isRequired,
  handleBeforeAddition: _propTypes2.default.func,
...
ReactTags.defaultProps = {
  ...
  handleBeforeAddition: function handleBeforeAddition() {
    return true;
  }
};
